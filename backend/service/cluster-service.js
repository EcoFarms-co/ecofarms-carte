...
exports.getAll = (token, callback) => {
    axios.get(config.url + '/api/clusters')
...
exports.get = (id, token, callback) => {
    axios.get(config.url + '/api/clusters/' + id)
        .then(function (response) {
            callback(response.data)
        })
        .catch(function (error) {
...
exports.create = (body, token, callback) => {
    ...
    // };
    axios.post(config.url + '/api/clusters', body)
        .then(function (response) {
...
exports.update = (id, body, token, callback) => {
    axios.put(config.url + '/api/clusters/' + id, body)
        .then(function (response) {
...
exports.delete = (id, token, callback) => {
    axios.delete(config.url + '/api/clusters/' + id)
        .then((response) => {
